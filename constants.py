...
class UUIDS(object):
    ...
    CHARACTERISTIC_DEVICE_EVENT = "00000010-0000-3512-2118-0009af100700"
...
class AUTH_STATES(object):
    ...
    ENCRYPTION_KEY_FAILED = "Encryption key auth fail, sending new key"
